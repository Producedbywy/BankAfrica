          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              {section.items.map((item) => (
                ...
                >
                  <span className="text-lumo-teal group-hover:text-lumo-orange transition-colors mb-2">
                    {item.icon}
                  </span>
                  <span className="text-sm font-medium text-lumo-cream/80 group-hover:text-white transition-colors">
                    {item.name}
                  </span>
                </button>
              ))}
